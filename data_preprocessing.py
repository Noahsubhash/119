...
def get_pattern_words(words, ignore_words):
    pattern_words = []
    for word in words:
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        for pattern in intent['patterns']:  
            ...
            pattern_words = sorted(list(set(pattern_words)))
            classes = sorted(list(set(classes)))

            pickle.dump(pattern_words, open('words.pkl','wb'))
            pickle.dump(classes, open('classes.pkl','wb'))

        return pattern_words, classes
    ...
    pattern_words = get_pattern_words(words, ignore_words) 

    # Remove duplicate words from pattern_words

    # sort the pattern_words list and classes list

    
    # print pattern_words
    print('pattern_words list : ' , pattern_words)

    return pattern_words, classes, pattern_word_tags_list
...
def bag_of_words_encoding(pattern_words, pattern_word_tags_list):
    ...
    for word_tags in pattern_word_tags_list:
        ...
        stemmed_pattern_word = get_pattern_words(pattern_words, ignore_words)
...
def preprocess_train_data():
    ...
    pattern_words, tag_classes, word_tags_list = create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words)
    
    # Convert Stem words and Classes to Python pickel file format
    training_data = np.array(training_data, dtype=object)

    train_x = bag_of_words_encoding(pattern_words, word_tags_list)
